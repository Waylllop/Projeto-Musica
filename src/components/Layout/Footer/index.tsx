...
const Footer = () => {
  return (
    <footer className="bg-dark flex justify-between px-6 md:px-10 lg:px-16 py-4 pb-20">
      <h1 className="text-lg lg:text-2xl font-coustard text-light">yLLop © 2023</h1>
