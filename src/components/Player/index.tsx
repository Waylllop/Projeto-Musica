...
const Player = () => {
  ...
  return (
    <div className="w-full">
      <div className="w-full h-16 bg-dark text-light relative md:px-10">
        <SongSlider
        ...
        />
        <div className="relative h-16 px-12 min-[550px]:px-10 lg:px-14 grid justify-center items-center mt-[-28px] lg:mt-[-24px] grid-cols-[45%_1fr_45%] md:grid-cols-[35%_1fr_20%_15%] lg:grid-cols-[40%_1fr_25%_15%]">
